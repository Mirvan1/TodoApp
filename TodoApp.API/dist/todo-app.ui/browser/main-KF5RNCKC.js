...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-BU4HO77V.js").then((m) => m.LoginComponent)
  },
  {
    path: "register",
    loadComponent: () => import("./chunk-IEXLBDZK.js").then((m) => m.RegisterComponent)
  },
  {
    path: "todo",
...
var _AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const moduleImpl = this.moduleImpl ?? import("./chunk-AYRF4XBI.js");
